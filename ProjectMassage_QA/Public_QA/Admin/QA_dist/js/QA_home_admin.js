        ...
        success: function (result) {
            ...
            if (result != null) {
                ...
                for (var i = 0; i < length; i++) {
                    var phantramgiam = obj[i].phantramgiam;
                    ...
                    var time2 = moment(time).format("DD/MM/YYYY");
                    var data =
                        '<tr>' +
                        '<td class="text-danger">' + (i + 1) + '</td>' +
                        '<td class="text-left">' + obj[i].O_number + '</td>' +
                        '<td class="text-left">' + obj[i].Name_User + '</td>' +
                        '<td class="text-left">' + time2 + '</td>' +
                        '<td class="text-left">' + phantramgiam + '</td>' +
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < list_oder; i++) {
                debugger
                var tendichvu = result[i].Tendichvu;
                if (tendichvu == null) {
                    tendichvu = "";
                }
                if (view.indexOf("|" + result[i].Id + "|") === -1) {
                    ...
                    var Set_data =
                        ...
                        '</td>' +
                        '<td>' +
                        '<span id="IdCate_' + result[i].Id + '" data-name="' + result[i].Id_tang + '" data-id="' + result[i].Id_service2 + '"><b>' + tendichvu + '</b></span>' +
                        '</td>' +
