...
var CalendarComponent = /** @class */ (function (_super) {
    ...
    CalendarComponent.prototype._renderToolbars = function (viewSpec, dateProfile, currentDate, title) {
        var _a = this, context = _a.context, header = _a.header,room = _a.room;
        var options = context.options, calendar = context.calendar;
        var headerLayout = options.header;
        varroomLayout = options.room;
        ...
        if (roomLayout) {
            if (!room) {
             room = this.room = new Toolbar('fc-room-toolbar');
                appendToElement(this.el,room.el);
            }
         room.receiveProps(__assign({ layout:roomLayout }, toolbarProps), context);
        }
        else if (room) {
         room.destroy();
         room = this.room = null;
    ...
    CalendarComponent.prototype.queryToolbarsHeight = function () {
        ...
        if (this.room) {
            height += computeHeightAndMargins(this.room.el);
        }
        return height;
    };
    // Height "Freezing"
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    Calendar.prototype.getUnitViewSpec = function (unit) {
        ...
        if (component.room) {
            viewTypes.push.apply(viewTypes, component.room.viewsWithButtons);
        }
